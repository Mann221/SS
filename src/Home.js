    ...
    <main className="flex flex-col min-h-screen items-center justify-center bg-background">
      ...
      <section className="w-screen h-screen flex flex-col px-20 items-center justify-start">
        ...
        <div className="flex items-center justify-start mt-10 space-x-4">
          <div className="bg-[#D2F6D5] w-96 h-72 rounded-l-xl flex flex-col items-center justify-center gap-5 p-5 shadow-xl">
            <HolisticApproach />
          ...
          <div className="bg-[#FEFEFE] w-96 h-96 rounded-xl flex flex-col items-center justify-center gap-5 p-5 shadow-xl">
            <GreatCommunity />
          ...
          <div className="bg-[#D2F6D5] w-96 h-72 rounded-r-xl flex flex-col items-center justify-center gap-5 p-5 shadow-xl">
            <Accessibility />
      ...
      <section className="relative w-screen flex flex-col items-center justify-center">
        <div className="text-center text-black text-xl font-semibold -mt-32">Services</div>
